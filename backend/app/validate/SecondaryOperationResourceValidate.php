...
final class SecondaryWarehouseCreateValidate extends Validate { protected $rule=['warehouse_code'=>'require|max:64','name'=>'require|max:120','supplier_id'=>'integer|gt:0','status'=>'in:active,disabled']; }
final class SecondaryWarehouseUpdateValidate extends Validate { protected $rule=['name'=>'max:120','supplier_id'=>'integer|gt:0','status'=>'in:active,disabled']; }
